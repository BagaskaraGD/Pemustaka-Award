                    ...
                    <tbody>
                        @foreach ($top5 as $index => $user)
                            ...
                            <tr class="{{ $index % 2 == 0 ? 'bg-gray-100' : 'bg-white' }}">
                                ...
                                <td class="p-3 font-rubik font-bold text-[#880e4f]">{{ $user['nama'] ?? '-' }}
                                </td>
                                <td class="p-3 font-rubik font-bold text-[#880e4f]">{{ $user['nim'] ?? '-' }}
                                </td>
                                <td class="p-3 font-rubik font-bold text-[#880e4f]">{{ $user['status'] ?? '-' }}
                                </td>
            ...
            <table class="min-w-full text-gray-700 border-collapse">
                <thead class="p-0">
                    ...
                    <tr class="bg-white border-t border-gray-300">
                        ...
                        <th class="p-3 font-rubik text-left border-t border-gray-300">Profile</th>
                        <th class="p-3 font-rubik text-left border-t border-gray-300">Nama</th>
                        <th class="p-3 font-rubik text-left border-t border-gray-300">NIK</th>
