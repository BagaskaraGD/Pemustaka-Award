...
@section('content')
    <div class="max-w-5xl mx-auto pt-16">
        ...
        <div class="bg-white shadow-md p-6 relative">
            ...
            <div
                class="absolute left-0 top-0 w-3/5 h-36 bg-[#880e4f] rounded-tr-full rounded-br-full transform z-0 drop-shadow-[2px_6px_20px_rgba(0,0,0,0.5)] flex items-center px-6">
                <div class="w-20 h-20 bg-[#880e4f] rounded-full ml-5">
            ...
            <div class="flex">
                <div class="flex flex-col items-end ml-auto pr-20">
                    <div class="inline-flex items-end space-x-1">
                        ...
                        <p id="peringkat" class="text-6xl font-bold font-russo text-[#880e4f]"></p>
                    </div>
                    <a href="/leaderboard-dosen">
                        <button
                            class="bg-[#880e4f] text-white font-rubik px-4 py-2 rounded-md mt-2 mr-14">Leaderboard</button>
                    </a>
                </div>
            </div>
                ...
                <div class="mt-6 relative h-10 flex justify-around">
                    <div id="claim-button-wrapper-lvl1" class="claim-button-wrapper"
                        ...
                        <button id="claim-button1" data-level="1"
                            class="claim-reward-button bg-[#880e4f] font-rubik text-white px-4 py-2 rounded-md"
        ...
        <div class="bg-white shadow-md p-6 mt-6">
            ...
            <div class="grid grid-cols-4 text-center text-lg font-semibold">
                <div>
                    ...
                    <p id="kunjungan-count" class="text-3xl font-bold font-russo text-[#880e4f]">0</p>
                </div>
                <div>
                    <p class="text-gray-500 font-rubik">Peminjaman</p>
                    <p id="pinjaman-count" class="text-3xl font-bold font-russo text-[#880e4f]">0</p>
                </div>
                <div>
                    <p class="text-gray-500 font-rubik">Kegiatan</p>
                    <p id="kegiatan-count" class="text-3xl font-bold font-russo text-[#880e4f]">0</p>
                </div>
                <div id="challenge-container">
                    <p class="text-gray-500 font-rubik">Challenge</p>
                    <p id="challenge-count" class="text-3xl font-bold font-russo text-[#880e4f]">0</p>
                </div>
            </div>
        </div>
    </div>
