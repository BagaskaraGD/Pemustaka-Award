        ...
        <div class="bg-white shadow-md p-6 relative">
            ...
            <div class="flex">
                <div class="flex flex-col items-end ml-auto pr-20">
                    <div class="inline-flex items-end space-x-1">
                        ...
                        <p class="text-6xl font-bold font-russo text-[#880e4f]">21</p>
                    </div>
                    <a href="/"><button
                            class="bg-[#880e4f] text-white font-rubik px-4 py-2 rounded-md mt-2 mr-14">Leaderboard</button></a>
                </div>
            </div>
            ...
            <div class="mt-10">
                ...
                <div class="relative bg-gray-300 h-7 rounded-full mt-2">
                    ...
                    <div class="bg-[#880e4f] h-7 w-1/3 rounded-full"></div>
                </div>

                <button class="block bg-[#880e4f] font-rubik text-white px-4 py-2 rounded-md mt-4 ml-72"
        ...
        <div class="bg-white  shadow-md p-6 mt-6">
            ...
            <div class="grid grid-cols-4 text-center text-lg font-semibold">
                <div>
                    ...
                    <p class="text-3xl font-bold font-russo text-[#880e4f]">0</p>
                </div>
                <div>
