    ...
    <div class="max-w-5xl mx-auto px-4 pt-4 md:pt-16">
        ...
        <div class="bg-white shadow-lg rounded-xl p-4 md:p-6">
            ...
            <div class="relative md:h-36 flex flex-col md:flex-row">
                ...
                <div
                    class="md:absolute md:left-0 md:top-0 w-full md:w-3/5 md:h-full bg-[#1F4C6D] rounded-xl md:rounded-none md:rounded-tr-full md:rounded-br-full flex items-center px-6 py-4 shadow-lg md:drop-shadow-[2px_6px_20px_rgba(0,0,0,0.5)] z-10">
                ...
                <div class="w-full flex flex-col items-center md:items-end mt-4 md:mt-0 md:pl-[60%]">
                    <div class="flex items-center space-x-2 md:space-x-1">
                        ...
                        <p id="peringkat" class="text-5xl md:text-6xl font-bold font-russo text-[#1F4C6D]">-</p>
                    </div>
                    <a href="/leaderboard-mhs" class="w-full md:w-auto mt-2">
                        <button class="bg-[#1F4C6D] text-white font-rubik px-4 py-2 rounded-md w-full md:w-auto">
                            Leaderboard
                        </button>
                    </a>
                </div>
        ...
        <div class="bg-white shadow-lg rounded-xl p-6 mt-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                <div>
                    ...
                    <p id="kunjungan-count" class="text-2xl md:text-3xl font-bold font-russo text-[#1F4C6D]">0</p>
                </div>
                <div>
                    <p class="text-gray-500 font-rubik text-sm md:text-base">Peminjaman</p>
                    <p id="pinjaman-count" class="text-2xl md:text-3xl font-bold font-russo text-[#1F4C6D]">0</p>
                </div>
                <div>
                    <p class="text-gray-500 font-rubik text-sm md:text-base">Kegiatan</p>
                    <p id="kegiatan-count" class="text-2xl md:text-3xl font-bold font-russo text-[#1F4C6D]">0</p>
                </div>
                <div>
                    <p class="text-gray-500 font-rubik text-sm md:text-base">Challenge</p>
                    <p id="challenge-count" class="text-2xl md:text-3xl font-bold font-russo text-[#1F4C6D]">0</p>
                </div>
            </div>
        </div>
    </div>
