        ...
        <aside class="w-64 bg-white p-5 shadow-md h-screen fixed top-0 left-0">
            ...
            <nav class="mt-5">
                <ul>
                    ...
                    <li>
                        <div
                            class="flex items-center p-3 rounded-lg {{ Request::is('aksara-dosen') || Request::is('formaksaradinamika-dosen') ? 'bg-[#880e4f] text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                            <img src="{{ Request::is('aksara-dosen') || Request::is('formaksaradinamika-dosen') ? asset('assets/images/Aksara.png') : asset('assets/images/BlackAksara.png') }}"
