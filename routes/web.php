...
Route::post('/login', [LoginController::class, 'authenticate'])->name('login.authenticate'); // Nama sudah diperbaiki dari error sebelumnya
...
Route::middleware(['check.session', 'period.status'])->group(function () {
    ...
    Route::middleware(['check.mahasiswa'])->group(function () {
        // NAMA METHOD DISESUAIKAN DENGAN FILE CONTROLLER
